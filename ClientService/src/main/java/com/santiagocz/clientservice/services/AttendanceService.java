...
public class AttendanceService {
    ...
    public AttendanceResponseDto checkIn(String dni) {
        ...
        if (!alreadyAttendedToday) {
            // Primera entrada del día: validar límite semanal
            ...
            checkOut = LocalDateTime.now().plusHours(DAILY_TRAINING_WINDOW_HOURS);

        } else {
            // Reentrada: validar ventana
            Attendance firstToday = attendanceRepository
                    .findFirstByMemberIdAndCheckInBetweenOrderByCheckInAsc(
